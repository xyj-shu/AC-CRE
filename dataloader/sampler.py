...
class DataSampler(object):
    ...
    def __init__(self, args, seed=None):
        self.set_path(args)
        self.args = args
        temp_name = [args.data_name, args.seed]
    ...
    def set_path(self, args):
        use_marker = ""
        if args.data_name in ['FewRel']:
            args.data_file = os.path.join(args.data_path, 'FewRel', "data_with{}_marker.json".format(use_marker))
            args.relation_file = os.path.join(args.data_path, 'FewRel', "id2rel.json")
            args.num_of_relation = 80
            args.num_of_train = 420
            args.num_of_val = 140
            args.num_of_test = 140
        elif args.data_name in ['TACRED']:
            args.data_file = os.path.join(args.data_path, 'TACRED', "data_with{}_marker_tacred.json".format(use_marker))
            args.relation_file = os.path.join(args.data_path, 'TACRED', "id2rel_tacred.json")
